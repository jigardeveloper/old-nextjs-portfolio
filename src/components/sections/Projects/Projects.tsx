  ...
  const ProjectsCards: ProjectCardProps[] = [
    {
      ...
      titleComponent: { Gujarati: "Move Stats", English: "Move Stats",Hindi:"" },
      description: {
        Gujarati:
          "Projeto finalista na FEBRACE 2022 desenvolvido para facilitar na locomoção de deficientes visuais.",
        English:
          "FEBRACE 2022 finalist project developed to facilitate transportation for visually impaired individuals.",
          Hindi:""
      },
    ...
    },
    {
      ...
      titleComponent: { Gujarati: "PokeStack", English: "PokeStack",Hindi:"" },
      description: {
        Gujarati:
          "Pokedex criada com Next e TypeScript com autenticação de usuário.",
        English:
          "Pokedex made with Next and TypeScript contains user authentication",
          Hindi:""
      },
    ...
    },
    {
      ...
      titleComponent: { Gujarati: "Akame Wiki", English: "Akame Wiki",Hindi:"" },
      description: {
        Gujarati:
          "Site feito para aprimorar meus conhecimentos com react e consumo de APIs.",
        English:
          "Website created to enhance my skills with React and API consumption.",
          Hindi:""
      },
    ...
    {
      imgSrc: Sorteio.src,
      titleComponent: { Gujarati: "Sorteio", English: "Draw",Hindi:"" },
      description: {
        Gujarati: "Site simples feito com Next para sorteio de números!",
        English: "Simple website made with Next for number drawing!",
        Hindi:""
      },
    ...
    },
    {
      ...
      titleComponent: { Gujarati: "Github", English: "Github",Hindi:"Github" },
      description: {
        Gujarati: "Acesse meu github para ver todos meus os projetos.",
        English: "Visit my Github to see all of my projects",
        Hindi:"Visit my Github to see all of my projects"
      },
            ...
            return (
              ...
              >
                <Carousel
                  height={item.height}
                  width={item.width}
                  yOrigin={item.height / 10}
                  yRadius={item.height / 6}
                  xOrigin={item.width / 2}
                  xRadius={item.width / 2.3}
                  autoPlay={true}
                >
