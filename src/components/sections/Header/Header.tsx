...
const Header = ({
  ...
  const ToggleMode = () => {
    ...
    document.body.style.setProperty(
      "--bgColor",
      DarkMode ? "rgb(229 231 235)" : "rgb(24 24 27)"
    );
    document.body.style.setProperty(
      "--inputColor",
      DarkMode ? "rgb(209 213 219)" : "rgb(31 41 55)"
    );
  ...
  useEffect(() => {
    ...
    document.body.style.setProperty(
      "--bgColor",
      theme != "light" ? "rgb(24 24 27)" : "rgb(229 231 235)"
    );
    document.body.style.setProperty(
      "--inputColor",
      theme != "light" ? "rgb(31 41 55)" : "rgb(209 213 219)"
    );
  }, []);
  ...
  return (
    <header id="#top">
      <nav className="w-full fixed z-[999] bg-neutral-800 px-12 flex items-center justify-center h-[12vh] min-h-[4rem] mdlg:justify-between">
        <a
          href="#top"
          className="text-center text-transparent text-2xl bg-clip-text gradient-text transition-all duration-300 hover:scale-105 mdlg:text-left"
        >
          Jigar
        </a>
        ...
        <ul
          className={clsx(
            "bg-gray-900 fixed top-[12vh] z-[999] right-0 h-[88vh] flex-col flex items-center justify-center duration-500 transition-all ease-out gap-5 mdlg:static mdlg:flex-row mdlg:w-full mdlg:h-auto mdlg:bg-transparent mdlg:duration-[0ms]",
            State ? "w-[180px]" : "w-0"
          )}
        >
          ...
          <ItemUl state={State} link="Servicos">
            {language === "English" ? "Services" : "Serviços"}
          </ItemUl>
          ...
          <div
            className={clsx(
              "flex items-center justify-center gap-6 absolute right-0 bottom-5 w-full mdlg:hidden",
          ...
          >
            ...
            <li className="text-xxl">
              <a
                href="https://github.com/Jigar-Ahir"
        ...
        <ul className="hidden items-center justify-center gap-4 text-gray-200 mdlg:flex mb-1">
